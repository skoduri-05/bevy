...
import BevinPage from "../pages/Bevin";
import SearchPage from "../pages/Search";
import NetworkPage from "../pages/Wishlist";
...
export default function BevyApp() {
    ...
    // Listen for an external request to open the auth screen (used by pages to trigger login)
    useEffect(() => {
        const onOpenAuth = () => setScreen("auth");
        window.addEventListener("bevy:open-auth", onOpenAuth);
        return () => window.removeEventListener("bevy:open-auth", onOpenAuth);
    }, []);
    ...
    // density is kept for settings but we don't pass compact props to pages currently
