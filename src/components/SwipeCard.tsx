...
export default function SwipeCard({
  ...
  card: Recipe & {
    user?: { name?: string | null; handle?: string | null; avatar_url?: string | null };
  };
  ...
  return (
    ...
    >
      <motion.div
        ...
        onDragEnd={() => {
          const dx = x.get();
          if (dx > threshold) onSwipeRight(card.uuid);
          else if (dx < -threshold) onSwipeLeft(card.uuid);
        }}
      ...
      >
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="ml-auto text-[10px] px-3 py-1 rounded-full bg-bevy-chip border border-[color:theme(colors.bevy.stroke)]">
              Follow
            </button>
          </div>
